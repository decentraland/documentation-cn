...
[浏览场景](https://the-munastery-ggtyhuetbt.now.sh)
...
[浏览场景](https://shark-animation-qehbwatsry.now.sh)
...
[浏览场景](https://open-door-inqgibkgwc.now.sh)
...
[浏览场景](https://sliding-door-nzpxlhlaiy.now.sh)
...
[浏览场景](https://dancefloor-rsylsclrna.now.sh)
...
[浏览场景](https://smoke-sjjygzpfug.now.sh)
...
[浏览场景](https://memory-game-vkysoawcea.now.sh)
...
[浏览场景](https://hummingbirds-unrchjydpo.now.sh)
...
[浏览场景](https://weather-pkfkpxankv.now)
...
创建能与玩家交互的自定义 UI，并能根据玩家在世界中的交互情况更新。

[代码](https://github.com/decentraland-scenes/Mining-rocks)

[浏览场景](https://mining-rocks-pjyyjqdfdt.now.sh)
...
[浏览场景](https://mana-transaction-jfsdmqqnmp.now.sh)
...
[浏览场景](https://mana-altar-nmfgwmfbjo.now.sh)
